...
export class VoterdetailsComponent implements OnInit {
  voter: any; // Voter details
  electionsWithCandidates: any[] = []; // List of ongoing elections with their candidates
  selectedElectionId: number | null = null; // Track selected election ID
  selectedCandidateId: number | null = null; // Track selected candidate ID
  private APIUrl = 'https://localhost:7181/api/Voter/'; // Your API URL
